...
export default class LoginPage extends AbstractFormPage {
   ...
   */
  constructor(container, {successfulLoginHandler, titleService, apiService}) {
    super(container, {successfulResponseHandler: successfulLoginHandler, titleService, apiService});
  }
