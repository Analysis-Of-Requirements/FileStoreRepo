...
export default class RegistrationPage extends AbstractFormPage {
   ...
   */
  constructor(container, {successfulRegistrationHandler, titleService, apiService}) {
    super(container, {successfulResponseHandler: successfulRegistrationHandler, titleService, apiService});
  }
