...
public final class LoggedInUserRecord implements Record<Token> {
    ...
    public static LoggedInUserRecord fromDto(Dto dto) {
        return new LoggedInUserRecord(new Token(dto.token), new UserId(dto.user_id), new ExpirationTime(dto.expiration_time));
    }
