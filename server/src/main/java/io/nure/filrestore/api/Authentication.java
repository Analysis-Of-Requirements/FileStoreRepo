...
/**
 * The process of authenticating a user into the {@link FileStoreWebApplication}. Executes
...
public class Authentication implements ApplicationProcess {
    ...
    public Token handle(AuthenticateUser command) throws UserNotAuthenticatedException {
        ...
        String passwordHash = HashEncoder.encode(command.password().value());
        ...
        ExpirationTime expirationTime = ExpirationTimeCreator.expireAfterDays(DEFAULT_TOKEN_EXPIRATION_DAYS);
